        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          <div className="space-y-8 animate-fade-in-up">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
              <Link 
                to="/courses" 
                className="group flex items-center justify-center gap-3 bg-white text-primary-600 px-8 py-4 rounded-full font-semibold text-lg hover:shadow-2xl transition-all duration-300 hover:scale-105 hover:bg-gradient-to-r hover:from-white hover:to-gray-50"
              >
                Get Started
              ...
              <Link 
                to="/practice" 
                className="flex items-center justify-center gap-3 bg-white/20 backdrop-blur-lg text-white px-8 py-4 rounded-full font-semibold text-lg hover:bg-white/30 transition-all duration-300 hover:scale-105 border-2 border-white/30"
              >
                Try Free Lesson
              </Link>
            </div>
          ...
          <div className="relative animate-slide-in-right order-first md:order-last">
            <div className="relative glass-effect rounded-3xl p-6 md:p-8 shadow-2xl animate-float">
              <div className="flex items-center justify-center w-full h-80 bg-gradient-to-br from-primary-400 to-secondary-400 rounded-2xl">
                <Mic size={120} className="text-white animate-pulse-slow" />
              </div>
              {/* Floating badges */}
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20 lg:py-24">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature, index) => (
            <div 
              key={index} 
              className="group glass-effect rounded-2xl p-6 card-hover animate-fade-in-up"
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20 lg:py-24">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {testimonials.map((testimonial, index) => (
            <div 
              key={index}
              className="glass-effect rounded-2xl p-6 card-hover animate-fade-in-up"
              style={{ animationDelay: `${index * 0.1}s` }}
            >
        ...
        <div className="glass-effect rounded-3xl p-8 md:p-12 animate-fade-in-up">
          <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div className="bg-gradient-to-br from-primary-400 to-secondary-400 rounded-2xl p-8 flex items-center justify-center">
                <div className="relative">
                  ...
                  <div className="absolute -top-4 -right-4 bg-white rounded-xl p-3 shadow-lg">
                    ...
                    <p className="text-sm font-semibold text-gray-800">Your Progress so far!</p>
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-wrap gap-3 pt-4">
                <span className="px-4 py-2 bg-primary-100 text-primary-700 rounded-full text-sm font-medium">Live Sessions</span>
                <span className="px-4 py-2 bg-secondary-100 text-secondary-700 rounded-full text-sm font-medium">Personal Trainer</span>
                <span className="px-4 py-2 bg-green-100 text-green-700 rounded-full text-sm font-medium">3x Faster Results</span>
              </div>
            </div>
          </div>
        </div>
